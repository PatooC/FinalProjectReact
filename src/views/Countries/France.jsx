...
import { getFranceUniversities } from '../../api/Universities'
...
const France = () => {
    ...
    const getFranceUniversitiesFromAPI = async () => {
        try {
            const UnisNoFilter = await getFranceUniversities();
            setLoading(false)
