...
import { getBrazilianUniversities } from '../../api/Universities'
...
const UniSel = () => {
    ...
    const getBrazilianUniversitiesFromAPI = async () => {
        try {
            const UnisNoFilter = await getBrazilianUniversities();
            setLoading(false)
    ...
    useEffect(() => {
        getBrazilianUniversitiesFromAPI()
    }, []);
