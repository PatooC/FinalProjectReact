...
import { getAmericanUniversities } from '../../api/Universities'
...
const USA = () => {
    ...
    const getAmericanUniversitiesFromAPI = async () => {
        try {
            const UnisNoFilter = await getAmericanUniversities();
            setLoading(false)
    ...
    useEffect(() => {
        getAmericanUniversitiesFromAPI()
    }, []);
