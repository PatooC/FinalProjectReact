...
import { getEnglishUniversities } from '../../api/Universities'
...
const England = () => {
    ...
    const getEnglishUniversitiesFromAPI = async () => {
        try {
            const UnisNoFilter = await getEnglishUniversities();
            setLoading(false)
