...
import { getChineseUniversities } from '../../api/Universities'
...
const China = () => {
    ...
    const getChineseUniversitiesFromAPI = async () => {
        try {
            const UnisNoFilter = await getChineseUniversities();
            setLoading(false)
