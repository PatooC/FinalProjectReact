...
import { getJapaneseUniversities } from '../../api/Universities'
...
const Japan = () => {
    ...
    const getJapaneseUniversitiesFromAPI = async () => {
        try {
            const UnisNoFilter = await getJapaneseUniversities();
            setLoading(false)
    ...
    useEffect(() => {
        getJapaneseUniversitiesFromAPI()
    }, []);
