...
import { getArgentinianUniversities } from '../../api/Universities'
...
const Argentina = () => {
    ...
    const getArgentinianUniversitiesFromAPI = async () => {
        try {
            const UnisNoFilter = await getArgentinianUniversities();
            setLoading(false)
    ...
    useEffect(() => {
        getArgentinianUniversitiesFromAPI()
    }, []);
