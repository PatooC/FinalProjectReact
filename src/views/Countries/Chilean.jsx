...
import { getChileanUniversities } from '../../api/Universities'
...
const Chilean = () => {
    ...
    const getChileanUniversitiesFromAPI = async () => {
        try {
            const UnisNoFilter = await getChileanUniversities();
            setLoading(false)
